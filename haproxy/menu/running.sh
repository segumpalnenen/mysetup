...
display_service_status() {
    ...
    # WebSocket Services
    echo -e "${WHITE} Haproxy Service        ${NC}: $(check_service_status haproxy.service systemctl)"
    echo -e "${WHITE} WebSocket              ${NC}: $(check_service_status ws-proxy.service systemctl)"
